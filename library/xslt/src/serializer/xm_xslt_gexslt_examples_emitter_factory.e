...
feature -- Element change
	...
	set_defaults (a_method_local_name: STRING; a_properties: XM_XSLT_OUTPUT_PROPERTIES; a_import_precedence: INTEGER)
		...
		do
			...
			-- E.g. a_properties.extension_attributes.force ("BUG - invalid dtd internal subset", "{http://gobo-eiffel.gobosoft.com/tool/gexslt/doc/extension/examples}internal-subset")
		end

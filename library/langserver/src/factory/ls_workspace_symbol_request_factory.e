...
feature -- Access
	...
	new_response_result (a_response: LS_RESPONSE; a_manager: LS_MESSAGE_MANAGER): detachable LS_WORKSPACE_SYMBOL_RESULT
		...
		do
			...
			elseif attached workspace_symbol_result_from_any (l_any, {LS_RESPONSE}.result_name) as l_workspace_symbol_result then

note
	...
	description:
		...
		"LSP 'textDocument/prepareCallHierarchy' dynamic registration options"

	library: "Gobo Eiffel Language Server Protocol Library"
	copyright: "Copyright (c) 2026, Eric Bezault and others"
	license: "MIT License"

class LS_CALL_HIERARCHY_REGISTRATION_OPTIONS
...
feature -- Processing
	...
	process (a_processor: LS_PROCESSOR)
		...
		do
			a_processor.process_call_hierarchy_registration_options (Current)
		end

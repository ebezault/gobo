note
	...
	description:
		...
		"LSP 'textDocument/prepareTypelHierarchy' dynamic registration options"

	library: "Gobo Eiffel Language Server Protocol Library"
	copyright: "Copyright (c) 2026, Eric Bezault and others"
	license: "MIT License"

class LS_TYPE_HIERARCHY_REGISTRATION_OPTIONS
...
inherit
	...
	LS_TYPE_HIERARCHY_OPTIONS
		rename
			make as make_call_hierarchy_options
		redefine
			process
		end
...
feature -- Processing
	...
	process (a_processor: LS_PROCESSOR)
		...
		do
			a_processor.process_type_hierarchy_registration_options (Current)
		end

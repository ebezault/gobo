note
	...
	description:
		...
		"LSP 'callHierarchy/incomingCalls' requests"

	library: "Gobo Eiffel Language Server Protocol Library"
	copyright: "Copyright (c) 2026, Eric Bezault and others"
	license: "MIT License"

class LS_CALL_HIERARCHY_INCOMING_CALLS_REQUEST

inherit

	LS_REQUEST

	LS_CALL_HIERARCHY_INCOMING_CALLS_PARAMS
...
feature {NONE} -- Initialization
	...
	make (a_id: like id; a_item: like item; a_work_done_token: like work_done_token; a_partial_result_token: like partial_result_token)
			-- Create a new 'callHierarchy/incomingCalls' request.
		require
...
feature -- Access
	...
	handler (a_manager: LS_MESSAGE_MANAGER): LS_CALL_HIERARCHY_INCOMING_CALLS_REQUEST_HANDLER
		...
		do
			Result := a_manager.call_hierarchy_incoming_calls_request_handler
		ensure then
			instance_free: class
		end
...
feature -- Processing
	...
	process (a_processor: LS_PROCESSOR)
		...
		do
			a_processor.process_call_hierarchy_incoming_calls_request (Current)
		end

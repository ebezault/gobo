note
	...
	description:
		...
		"LSP 'textDocument/prepareTypeHierarchy' requests"

	library: "Gobo Eiffel Language Server Protocol Library"
	copyright: "Copyright (c) 2026, Eric Bezault and others"
	license: "MIT License"

class LS_TYPE_HIERARCHY_PREPARE_REQUEST

inherit

	LS_REQUEST

	LS_TYPE_HIERARCHY_PREPARE_PARAMS
...
feature {NONE} -- Initialization
	...
	make (a_id: like id; a_text_document: like text_document; a_position: like position; a_work_done_token: like work_done_token)
			-- Create a new 'textDocument/prepareTypeHierarchy' request.
		require
...
feature -- Access
	...
	handler (a_manager: LS_MESSAGE_MANAGER): LS_TYPE_HIERARCHY_PREPARE_REQUEST_HANDLER
		...
		do
			Result := a_manager.type_hierarchy_prepare_request_handler
		ensure then
			instance_free: class
		end
...
feature -- Processing
	...
	process (a_processor: LS_PROCESSOR)
		...
		do
			a_processor.process_type_hierarchy_prepare_request (Current)
		end

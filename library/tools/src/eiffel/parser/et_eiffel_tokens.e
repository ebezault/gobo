...
feature -- Token codes
	...
	E_SOME: INTEGER = 310
	E_LAST_END: INTEGER = 311
	E_AGENT: INTEGER = 312
	E_INVARIANT: INTEGER = 313
	E_PRECURSOR: INTEGER = 314
	E_ARROW: INTEGER = 315
	E_DOTDOT: INTEGER = 316
	E_LARRAY: INTEGER = 317
	E_RARRAY: INTEGER = 318
	E_ASSIGN_SYMBOL: INTEGER = 319
	E_REVERSE: INTEGER = 320
	E_UNKNOWN: INTEGER = 321
	E_FALSE: INTEGER = 322
	E_TRUE: INTEGER = 323
	E_BREAK: INTEGER = 324
	E_CHARACTER: INTEGER = 325
	E_CURRENT: INTEGER = 326
	E_FREEOP: INTEGER = 327
	E_IDENTIFIER: INTEGER = 328
	E_TUPLE: INTEGER = 329
	E_NONE: INTEGER = 330
	E_INTEGER: INTEGER = 331
	E_AND: INTEGER = 332
	E_OR: INTEGER = 333
	E_XOR: INTEGER = 334
	E_NOT: INTEGER = 335
	E_IMPLIES: INTEGER = 336
	E_STRPLUS: INTEGER = 337
	E_STRMINUS: INTEGER = 338
	E_STRSTAR: INTEGER = 339
	E_STRSLASH: INTEGER = 340
	E_STRDIV: INTEGER = 341
	E_STRMOD: INTEGER = 342
	E_STRPOWER: INTEGER = 343
	E_STRLT: INTEGER = 344
	E_STRLE: INTEGER = 345
	E_STRGT: INTEGER = 346
	E_STRGE: INTEGER = 347
	E_STRAND: INTEGER = 348
	E_STROR: INTEGER = 349
	E_STRXOR: INTEGER = 350
	E_STRANDTHEN: INTEGER = 351
	E_STRORELSE: INTEGER = 352
	E_STRDOTDOT: INTEGER = 353
	E_STRBRACKET: INTEGER = 354
	E_STRPARENTHESIS: INTEGER = 355
	E_STRIMPLIES: INTEGER = 356
	E_STRFREEOP: INTEGER = 357
	E_STRNOT: INTEGER = 358
	E_STRING: INTEGER = 359
	E_STRANDSYMBOL: INTEGER = 360
	E_STRORSYMBOL: INTEGER = 361
	E_STRXORSYMBOL: INTEGER = 362
	E_STRANDTHENSYMBOL: INTEGER = 363
	E_STRORELSESYMBOL: INTEGER = 364
	E_STRIMPLIESSYMBOL: INTEGER = 365
	E_STRNOTSYMBOL: INTEGER = 366
	E_REAL: INTEGER = 367
	E_RESULT: INTEGER = 368
	E_RETRY: INTEGER = 369
	E_DIV: INTEGER = 370
	E_GE: INTEGER = 371
	E_LE: INTEGER = 372
	E_MOD: INTEGER = 373
	E_VOID: INTEGER = 374
	E_CHARERR: INTEGER = 375
	E_STRERR: INTEGER = 376
	E_OLD: INTEGER = 377
	E_FOR_ALL: INTEGER = 378
	E_THERE_EXISTS: INTEGER = 379
	E_BAR: INTEGER = 380
	E_OPEN_REPEAT: INTEGER = 381
	E_CLOSE_REPEAT: INTEGER = 382
	E_IMPLIES_SYMBOL: INTEGER = 383
	E_OR_SYMBOL: INTEGER = 384
	E_OR_ELSE_SYMBOL: INTEGER = 385
	E_XOR_SYMBOL: INTEGER = 386
	E_AND_SYMBOL: INTEGER = 387
	E_AND_THEN_SYMBOL: INTEGER = 388
	E_NOT_SYMBOL: INTEGER = 389
	E_NE: INTEGER = 390
	E_NOT_TILDE: INTEGER = 391
	E_ITERATION_CURSOR_SYMBOL: INTEGER = 392

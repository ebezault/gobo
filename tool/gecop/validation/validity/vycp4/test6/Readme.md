...
In this test, class `BB [G]` declares a conversion procedure of the form `f ({CC [ANY], CC [G]})`,
a but the two convert types have the same base class. This violates `VYCP-4`.

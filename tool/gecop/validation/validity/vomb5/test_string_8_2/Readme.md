...
In this test, the type of the choice `{STRING_32} "Ω"` in the multi-branch instruction is
different from the type of the inspect expression `STRING_8` and `"Ω"` cannot be represented
as a `STRING_8`. This violates `VOMB-5`.

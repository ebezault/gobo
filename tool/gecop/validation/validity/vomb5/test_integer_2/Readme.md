...
In this test, the type of the choice `{INTEGER_32} 300` in the multi-branch instruction is different
from the type of the inspect expression `INTEGER_8` and `300` cannot be represented as an `INTEGER_8`.
This violates `VOMB-5`.
